...
class OrchestratorTests(unittest.TestCase):
    ...
    def test_result_flow_has_real_screens_and_metric_definitions(self):
        ...
        self.assertEqual(definitions["result_messenger"]["parent_id"], "result_welcome")
        self.assertEqual(definitions["result_tube"]["parent_id"], "result_messenger")
        self.assertEqual(definitions["result_search"]["parent_id"], "result_tube")
        welcome_actions = {item["id"]: item for item in definitions["result_welcome"]["actions"]}
        self.assertEqual(welcome_actions["continue"]["target"], "result_messenger")
        self.assertEqual(welcome_actions["continue_identified"]["target"], "result_tube")
        messenger_actions = {item["id"]: item for item in definitions["result_messenger"]["actions"]}
        self.assertEqual(messenger_actions["continue"]["target"], "result_tube")
        self.assertEqual(messenger_actions["authenticated"]["target"], "result_tube")
        ...
        self.assertIn("continue_identified", app)
        self.assertIn("continue-to-tube", app)
