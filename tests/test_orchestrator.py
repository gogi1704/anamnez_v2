...
class OrchestratorTests(unittest.TestCase):
    ...
    def test_user_app_is_installable_pwa_without_caching_api_data(self):
        ...
        self.assertIn("consilium-shell-v54", worker)
        self.assertIn("fetch(request)", worker)
        self.assertIn("/static/styles.8aa9735c809a.css", index)
        self.assertIn("/static/rich-text.2bf1f5fab764.css", index)
        self.assertTrue((project_root / "static" / "styles.8aa9735c809a.css").is_file())
