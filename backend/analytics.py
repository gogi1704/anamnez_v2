    ...
    screens.extend([
        {
            ...
            "legacy_reach": [],
            "actions": [
                {"id": "continue", "label": "Далее — предложить вход", "target": "result_messenger", "legacy": []},
                {"id": "continue_identified", "label": "Далее — уже вошёл", "target": "result_tube", "legacy": []},
            ],
        },
        {
            "id": "result_messenger", "title": "Вход через мессенджер", "stage": "Результаты · вход",
            "kind": "result_messenger", "description": "Новому пользователю предлагается войти через Telegram или MAX до поиска пробирки.",
            "parent_id": "result_welcome", "flow": "result",
            "legacy_reach": [],
            "actions": [
                {"id": "link_messenger", "label": "Войти через мессенджер", "interaction": True, "legacy": []},
                {"id": "authenticated", "label": "Вход завершён", "target": "result_tube", "legacy": []},
                {"id": "continue", "label": "Продолжить без входа", "target": "result_tube", "legacy": []},
            ],
        },
        {
            "id": "result_tube", "title": "Номер пробирки", "stage": "Результаты · пробирка",
            "kind": "result_tube", "description": "Ввод индивидуального номера пробирки после предложения войти.",
            "parent_id": "result_messenger", "flow": "result",
            "legacy_reach": [],
            "actions": [{"id": "continue", "label": "Продолжить", "target": "result_search", "legacy": []}],
        },
        {
