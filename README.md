...
Метрика загружается без отдельного окна согласия, но автоматический просмотр
страницы не отправляется. Передаются только вручную заданные технические цели:
