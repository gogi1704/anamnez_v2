...
const AGENTS = {
  manager: { id: 'manager', name: 'Мария', role: 'Менеджер', initials: 'МН', icon: '✦', group: 'coordination' },
  ...
  general: { id: 'general', name: 'Максим', role: 'Общий специалист', initials: 'МО', icon: '◫', group: 'general' },
};
